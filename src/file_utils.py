...
def _prepare_output_docstrings(output_type, config_class):
    ...
    intro = (
        TF_RETURN_INTRODUCTION if output_type.__name__.startswith("TF") else PT_RETURN_INTRODUCTION
    )
    ...
    *docstr, tokenizer_class=None, checkpoint=None, output_type=None, config_class=None
    ...
    def docstring_decorator(fn):
        ...
        if "SequenceClassification" in model_class:
            ...
            code_sample = (
                TF_QUESTION_ANSWERING_SAMPLE if is_tf_class else PT_QUESTION_ANSWERING_SAMPLE
            )
        elif "TokenClassification" in model_class:
            code_sample = (
                TF_TOKEN_CLASSIFICATION_SAMPLE if is_tf_class else PT_TOKEN_CLASSIFICATION_SAMPLE
            )
        ...
        output_doc = (
            _prepare_output_docstrings(output_type, config_class) if output_type is not None else ""
        )
